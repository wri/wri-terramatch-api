                                ...
                                <td>
                                    <table cellpadding="0" cellspacing="0" border="0" width="500">
                                        <tr>
                                            ...
                                            <td width="308" height="32" bgcolor="#27A9E0" style="font-family: sans-serif; font-size: 14px; color: #000000; text-align: center;">
                                                <a href="{!! $frontend_url !!}{!! $link !!}" style="color: #000000; text-transform: uppercase; text-decoration: none;">
                                                    <strong>{!! $cta !!}</strong>
                                                </a>
                                            </td>
                                            <td width="96" height="32"></td>
