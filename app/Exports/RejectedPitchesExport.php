 ...
 */
class RejectedPitchesExport implements FromCollection, WithHeadings
{
    use Exportable;
    ...
    public function collection() : Collection
    {
        $query = DB::table('pitches')
            ->select([
                ...
                'pitch_versions.rejected_reason AS pitch_rejected_reason',
            ...
            ->orderBy('pitch_versions.created_at', "ASC");
        return $query->get();
    }
}
