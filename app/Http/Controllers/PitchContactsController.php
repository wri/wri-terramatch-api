...
class PitchContactsController extends Controller
{
    public function createAction(Request $request): JsonResponse
    {
        ...
        PitchContactValidator::validate("CREATE", $data);
        ...
        if (array_key_exists("user_id", $data) && array_key_exists("team_member_id", $data)) {
            ...
            $existingModel = PitchContactModel
        ...
        $pitchContact = new PitchContactModel($data);
    ...
    {
        $pitchContact = PitchContactModel::findOrFail($id);
