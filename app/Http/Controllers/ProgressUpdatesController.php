...
class ProgressUpdatesController extends Controller
{
    ...
    {
        $this->authorize("create", "App\\Models\\ProgressUpdate");
        ...
        $progressUpdate = new ProgressUpdateModel($data);
        $progressUpdate->created_by = $me->id;
    ...
    {
        $progressUpdate = ProgressUpdateModel::findOrFail($id);
    ...
    public function readAllByMonitoringAction(Request $request, Int $id): JsonResponse
    {
        $progressUpdates = ProgressUpdateModel
            ...
            ->get();
        $this->authorize("readAll", "App\\Models\\ProgressUpdate");
