...
class TargetsController extends Controller
{
    public function createAction(Request $request): JsonResponse
    {
        ...
        $this->authorize("create", "App\\Models\\Target");
    ...
    {
        $targets = TargetModel::where("monitoring_id", "=", $id)->orderBy("created_at", "asc")->get();
        $this->authorize("readAll", "App\\Models\\Target");
    ...
    public function acceptAction(Request $request, Int $id): JsonResponse
    {
        ...
        $latestTarget = TargetModel
            ::where("monitoring_id", "=", $target->monitoring_id)
