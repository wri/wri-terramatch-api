...
class PitchesController extends Controller
{
    ...
    public function createAction(Request $request): JsonResponse
    {
        ...
        PitchValidator::validate("CREATE", $childData);
        $me = Auth::user();
        $parentData = [
    ...
    public function updateAction(Request $request, int $id): JsonResponse
    {
        ...
        $childData = $request->json()->all();
        PitchValidator::validate("UPDATE", $childData);
        $me = Auth::user();
    ...
    public function updateVisibilityAction(Request $request, int $id): JsonResponse
    {
        ...
        PitchValidator::validate("UPDATE_VISIBILITY", $parentData);
    ...
    public function mostRecentAction(Request $request): JsonResponse
    {
        ...
        $versions =  PitchVersionModel::where('status', 'approved')
            ->orderBy('approved_rejected_at', 'DESC')
            ->with('parent')
            ->limit($limit)
            ->get();
    ...
    {
        $this->authorize("yes", "App\\Models\\Default");
        if (!in_array($continent, Config::get("data.continents"))) {
