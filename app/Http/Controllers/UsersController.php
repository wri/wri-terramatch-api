...
class UsersController extends Controller
{
    ...
    {
        $this->authorize('accept', \App\Models\User::class);
        $url = $request->get('callback_url') ? $request->get('callback_url') : null;
        $request->request->remove('callback_url');
        $data = $request->json()->all();
        UserValidator::validate('ACCEPT', $data);
        $user = UserModel::userOrTerrafundAdmin()
            ->invited()
    ...
    {
        $this->authorize('readAll', UserModel::class);
    ...
    public function updateRoleAction(Request $request, User $user): JsonResponse
    {
