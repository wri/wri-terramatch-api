...
class ProjectPitchResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        $data = [
            ...
            'level_0_proposed' => $this->level_0_proposed,
            'level_1_proposed' => $this->level_1_proposed,
            'level_2_proposed' => $this->level_2_proposed,
            'lat_proposed' => $this->lat_proposed,
            'long_proposed' => $this->long_proposed,
            'stakeholder_engagement' => $this->stakeholder_engagement,
            'landowner_agreement' => $this->landowner_agreement,
            'landowner_agreement_description' => $this->landowner_agreement_description,
            'land_tenure_distribution' => $this->land_tenure_distribution,
            'land_tenure_risks' => $this->land_tenure_risks,
            'non_tree_interventions_description' => $this->non_tree_interventions_description,
            'complement_existing_restoration' => $this->complement_existing_restoration,
            'land_use_type_distribution' => $this->land_use_type_distribution,
            'restoration_strategy_distribution' => $this->restoration_strategy_distribution,
            'total_tree_second_yr' => $this->total_tree_second_yr,
            'proj_survival_rate' => $this->proj_survival_rate,
            'anr_approach' => $this->anr_approach,
            'anr_rights' => $this->anr_rights,
            'project_site_model' => $this->project_site_model,
            'indigenous_impact' => $this->indigenous_impact,
            'barriers_project_activity' => $this->barriers_project_activity,
            'barriers_project_activity_description' => $this->barriers_project_activity_description,
            'other_engage_women_youth' => $this->other_engage_women_youth,
            'forest_fragments_distance' => $this->forest_fragments_distance,
            'anr_practices_proposed' => $this->anr_practices_proposed,
            'information_authorization' => $this->information_authorization,
