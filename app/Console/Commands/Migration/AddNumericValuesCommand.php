...
class AddNumericValuesCommand extends Command
{
    ...
    public function handle()
    {
        ...
        foreach ($projects as $project) {
            ...
            if (array_key_exists($countrySlug, $countriesBoundaries)) {
                $coordinates = $countriesBoundaries[$countrySlug];
                $project->update([
                    'lat' => $this->generateRandomDecimal($coordinates[1], $coordinates[3]),
                    'long' => $this->generateRandomDecimal($coordinates[0], $coordinates[2]),
                ]);
            }
        }
