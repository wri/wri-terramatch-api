...
use App\Mail\Match as MatchMail;
...
class NotifyMatchJob implements ShouldQueue
{
    ...
    {
        $interest = InterestModel::findOrFail($this->match->primary_interest_id);
        $this->notifyUsers(
            "Funder",
            $this->match->id,
        ...
        $this->notifyAdmins($this->match->id, $interest->pitch->approved_version->name, $interest->offer->name);
    }
