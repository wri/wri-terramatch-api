...
class NotifySatelliteMapCreatedJob implements ShouldQueue
{
    ...
    {
        $this->notifyUsers(
            $this->satelliteMap->monitoring->match->interest->offer->organisation_id,
            $this->satelliteMap->id,
            $this->satelliteMap->monitoring->match->interest->offer->name
        );
        $this->notifyUsers(
            $this->satelliteMap->monitoring->match->interest->pitch->organisation_id,
            $this->satelliteMap->id,
            $this->satelliteMap->monitoring->match->interest->pitch->approved_version->name
        );
    }
