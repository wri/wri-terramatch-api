...
class NotifyTargetAcceptedJob implements ShouldQueue
{
    ...
    {
        $offerOrganisationId = $this->target->monitoring->match->interest->offer->organisation_id;
        $pitchOrganisationId = $this->target->monitoring->match->interest->pitch->organisation_id;
