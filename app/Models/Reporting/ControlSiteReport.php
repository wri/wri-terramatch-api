...
class ControlSiteReport extends CustomReport implements CustomReportInterface
{
    ...
    {
        $export = [];
        $site = $this->exportable;
        $submissions = $this->date_from ? $site->submissions()->where('created_at', '>', $this->date_from)->get() : $site->submissions;
