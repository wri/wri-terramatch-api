...
final class TreeSpeciesVersionsControllerTest extends LegacyTestCase
{
    ...
    public function testReadAllByTreeSpeciesAction(): void
    {
        $token = Auth::attempt([
            'email_address' => 'steve@example.com',
            'password' => 'Password123',
    ...
    public function testReviveAction(): void
    {
        ...
        $response = $this->patchJson('/api/tree_species_versions/3/revive', $data, $headers);
        $response->assertHeader('Content-Type', 'application/json');
        $response->assertStatus(200);
        $response->assertJsonStructure([
            'data' => [
