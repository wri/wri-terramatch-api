...
class PitchesControllerTest extends TestCase
{
    ...
    public function testMostRecentAction()
    {
        $token = Auth::attempt([
            "email_address" => "andrew@example.com",
            "password" => "Password123"
    ...
    public function testCountByContinentAction()
    {
    ...
    public function testReadAllByContinentAction()
    {
    ...
    public function testUpdateVisibilityAction()
    {
        $token = Auth::attempt([
            "email_address" => "steve@example.com",
            "password" => "Password123"
    ...
    public function testUpdateVisibilityActionMonitoringExistsException()
    {
        $token = Auth::attempt([
