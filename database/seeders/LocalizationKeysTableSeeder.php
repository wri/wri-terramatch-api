...
class LocalizationKeysTableSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $this->createLocalizationKey('financial-report-reminder.body', 'This is a reminder that your financial report for {entityModelName} is due on {dueAt}.<br><br> 
            Here is a link to your “My Organization” page on TerraMatch, where you can find your report: <a href="{callbackUrl}" style="color: #6E6E6E;">Here.</a>
            You can find detailed guidance for this report here: <a href="{reportUrl}" style="color: #6E6E6E;">Here.</a>
