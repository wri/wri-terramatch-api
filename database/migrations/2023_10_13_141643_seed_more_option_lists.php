...
class SeedMoreOptionLists extends Migration
{
    /**
    ...
    {
        $collections = [
            'land-tenures' => ['Public', 'Private', 'Indigenous', 'Communal', 'National Protected Area'],
            'soil-condition' => ['Severely Degraded','Poor','Fair','Good','No Degradation'],
        ];
