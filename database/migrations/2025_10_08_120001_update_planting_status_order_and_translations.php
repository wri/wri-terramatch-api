...
return new class () extends Migration {
    ...
    public function up(): void
    {
        ...
        DB::statement("ALTER TABLE site_polygon MODIFY COLUMN planting_status ENUM('no-restoration-expected','not-started','in-progress','disturbed','replacement-planting','completed') NULL");
        DB::statement("ALTER TABLE v2_nurseries MODIFY COLUMN planting_status ENUM('no-restoration-expected','not-started','in-progress','replacement-planting','completed') NULL");
    ...
    public function down(): void
    {
        ...
        DB::statement("ALTER TABLE v2_projects MODIFY COLUMN planting_status ENUM('no-restoration-expected','not-started','in-progress','completed','replacement-planting') NULL");
        DB::statement("ALTER TABLE v2_sites MODIFY COLUMN planting_status ENUM('no-restoration-expected','not-started','in-progress','completed','replacement-planting') NULL");
        DB::statement("ALTER TABLE site_polygon MODIFY COLUMN planting_status ENUM('no-restoration-expected','not-started','in-progress','disturbed','completed','replacement-planting') NULL");
        DB::statement("ALTER TABLE v2_nurseries MODIFY COLUMN planting_status ENUM('no-restoration-expected','not-started','in-progress','completed','replacement-planting') NULL");
