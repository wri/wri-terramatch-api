    ...
    'models' => [
        'organisation' => [
            ...
            'fields' => [
                ...
                'org-consortium' => ['property' => 'consortium', 'label' => 'Organizations involved in consortium and description', 'input_type' => 'text'],
                'org-female-youth-leadership-example' => ['property' => 'female_youth_leadership_example', 'label' => 'Female or youth contribution to project leadership or decision making example', 'input_type' => 'text'],
                'org-level-0-past-restoration' => ['property' => 'level_0_past_restoration', 'label' => 'countries where organisation has previously restored land', 'input_type' => 'select', 'multichoice' => true, 'option_list_key' => 'countries'],
                'org-level-1-past-restoration' => ['property' => 'level_1_past_restoration', 'label' => 'GADM level 1 administrative areas where organisation has previously restored land', 'input_type' => 'select', 'multichoice' => true, 'option_list_key' => 'states'],
                'org-level-2-past-restoration' => ['property' => 'level_2_past_restoration', 'label' => 'GADM level 2 administrative areas where organisation has previously restored land', 'input_type' => 'text'],
        ...
        'project-pitch' => [
            ...
            'fields' => [
                ...
                'pro-pit-level-0-proposed' => ['property' => 'level_0_proposed', 'label' => 'countries where project will be restoring land', 'input_type' => 'select', 'multichoice' => true, 'option_list_key' => 'countries'],
                'pro-pit-level-1-proposed' => ['property' => 'level_1_proposed', 'label' => 'GADM level 1 administrative areas where project will be restoring land', 'input_type' => 'select', 'multichoice' => true, 'option_list_key' => 'states'],
                'pro-pit-level-2-proposed' => ['property' => 'level_2_proposed', 'label' => 'GADM level 2 administrative areas where project will be restoring land', 'input_type' => 'text'],
                ...
                'pro-pit-landowner-agreement-description' => ['property' => 'landowner_agreement_description', 'label' => 'Explanation of landowner agreement', 'input_type' => 'text'],
                'pro-pit-land-tenure-risks' => ['property' => 'land_tenure_risks', 'label' => 'Risks or challenges in securing tenure arrangements with landowners', 'input_type' => 'text'],
                'pro-pit-non-tree-interventions-description' => ['property' => 'non_tree_interventions_description', 'label' => 'Additional non-tree intervention description', 'input_type' => 'text'],
                'pro-pit-complement-existing-restoration' => ['property' => 'complement_existing_restoration', 'label' => 'Project complements existing restoration', 'input_type' => 'text'],
