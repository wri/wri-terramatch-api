    ...
    'models' => [
        'organisation' => [
            ...
            'fields' => [
                ...
                'org-hq-country' => ['property' => 'hq_country', 'label' => 'HQ country', 'input_type' => 'select',  'multichoice' => false, 'option_list_key' => 'gadm-level-0'],
                'org-countries' => ['property' => 'countries', 'label' => 'Countries', 'input_type' => 'select', 'multichoice' => true, 'option_list_key' => 'gadm-level-0'],
                ...
                'org-states' => ['property' => 'states', 'label' => 'States', 'input_type' => 'select', 'multichoice' => true, 'option_list_key' => 'gadm-level-1'],
                ...
                'org-land-systems' => ['property' => 'land_systems', 'label' => 'Land Systems', 'input_type' => 'select-image', 'multichoice' => true, 'option_list_key' => 'land-use-systems'],
                ...
                'org-tree-restoration-strategies' => ['property' => 'tree_restoration_practices', 'label' => 'Tree Restoration Practices', 'input_type' => 'select-image', 'multichoice' => true, 'option_list_key' => 'restoration-strategies'],
                ...
                'org-level-2-past-restoration' => ['property' => 'level_2_past_restoration', 'label' => 'GADM level 2 administrative areas where organisation has previously restored land', 'input_type' => 'select', 'multichoice' => true, 'option_list_key' => 'gadm-level-2'],
                'org-trees-naturally-regenerated-total' => ['property' => 'trees_naturally_regenerated_total', 'label' => 'Total trees naturally regenerated by organisation since founding', 'input_type' => 'number'],
                'org-trees-naturally-regenerated-3year' => ['property' => 'trees_naturally_regenerated_3year', 'label' => 'Total trees naturally regenerated by organisation in last 36 months', 'input_type' => 'number'],
                'org-carbon-credits' => ['property' => 'carbon_credits', 'label' => 'Has organisation ever issued carbon credits since founding', 'input_type' => 'conditional', 'multichoice' => false],
                'org-external-technical-assistance' => ['property' => 'external_technical_assistance', 'label' => 'Description of Non-Financial Technical Assistance Organisation has Received', 'input_type' => 'long-text'],
                'org-barriers-to-funding' => ['property' => 'barriers_to_funding', 'label' => 'Barriers organisation faces to accessing funding, scaling operations, or delivering impact', 'input_type' => 'long-text'],
                'org-capacity-building-support-needed' => ['property' => 'capacity_building_support_needed', 'label' => 'Where Support Needed for Project Capacity-Building', 'input_type' => 'long-text'],
                ...
                'org-territories-of-operation' => ['property' => 'territories_of_operation', 'label' => 'Territories in which the organization operates', 'input_type' => 'select', 'multichoice' => true, 'option_list_key' => 'land-tenures-brazil'],
                'org-decisionmaking-structure-description' => ['property' => 'decisionmaking_structure_description', 'label' => 'Organization’s decision-making structure', 'input_type' => 'long-text'],
                'org-decisionmaking-structure-individuals-involved' => ['property' => 'decisionmaking_structure_individuals_involved', 'label' => 'Individuals involved in decision-making structure', 'input_type' => 'long-text'],
                ...
                'org-anr-practices-past' => ['property' => 'anr_practices_past', 'label' => 'ANR practices that the organization has used', 'input_type' => 'select', 'multichoice' => true, 'option_list_key' => 'anr-practices'],
        ...
        'project-pitch' => [
            ...
            'fields' => [
                ...
                'pro-pit-country' => ['property' => 'project_country', 'label' => 'Country', 'input_type' => 'select', 'multichoice' => false, 'option_list_key' => 'gadm-level-0'],
                'pro-pit-rst-inv-types' => ['property' => 'restoration_intervention_types', 'label' => 'Restoration intervention types', 'input_type' => 'select-image', 'multichoice' => true, 'option_list_key' => 'land-use-systems'],
                ...
                'pro-pit-land-tenure-proj-area' => ['property' => 'land_tenure_proj_area', 'label' => 'Land tenure project area', 'input_type' => 'select', 'multichoice' => true, 'option_list_key' => 'land-tenures-brazil'],
                ...
                'pro-pit-states' => ['property' => 'states', 'label' => 'States', 'input_type' => 'select', 'multichoice' => true, 'option_list_key' => 'gadm-level-1'],
                ...
                'pro-pit-land-systems' => ['property' => 'land_systems', 'label' => 'Land systems', 'input_type' => 'select', 'multichoice' => true, 'option_list_key' => 'land-use-systems'],
                'pro-pit-tree-rest-prac' => ['property' => 'tree_restoration_practices', 'label' => 'Tree Restoration Practices', 'input_type' => 'select-image', 'multichoice' => true, 'option_list_key' => 'restoration-strategies'],
                ...
                'pro-pit-land-use-types' => ['property' => 'land_use_types', 'label' => 'Land use types', 'input_type' => 'select-image', 'multichoice' => true, 'option_list_key' => 'land-use-systems'],
                'pro-pit-restoration_strategy' => ['property' => 'restoration_strategy', 'label' => 'Restoration strategy', 'input_type' => 'select-image', 'multichoice' => true, 'option_list_key' => 'restoration-strategies'],
                ...
                'pro-pit-level-0-proposed' => ['property' => 'level_0_proposed', 'label' => 'countries where project will be restoring land', 'input_type' => 'select', 'multichoice' => true, 'option_list_key' => 'gadm-level-0'],
                'pro-pit-level-1-proposed' => ['property' => 'level_1_proposed', 'label' => 'GADM level 1 administrative areas where project will be restoring land', 'input_type' => 'select', 'multichoice' => true, 'option_list_key' => 'gadm-level-1'],
                'pro-pit-level-2-proposed' => ['property' => 'level_2_proposed', 'label' => 'GADM level 2 administrative areas where project will be restoring land', 'input_type' => 'select', 'multichoice' => true, 'option_list_key' => 'gadm-level-2'],
                'pro-pit-lat-proposed' => ['property' => 'lat_proposed', 'label' => 'Proposed center point of a restoration site - latitude', 'input_type' => 'number'],
                'pro-pit-long-proposed' => ['property' => 'long_proposed', 'label' => 'Proposed center point of a restoration site - longitude', 'input_type' => 'number'],
                'pro-pit-stakeholder-engagement' => ['property' => 'stakeholder_engagement', 'label' => 'Local stakeholders affected by project', 'input_type' => 'long-text'],
                'pro-pit-landowner-agreement' => ['property' => 'landowner_agreement', 'label' => 'Prior agreement with landowner to use their land for restoration', 'input_type' => 'select', 'multichoice' => false, 'option_list_key' => 'landowner-collection'],
                'pro-pit-landowner-agreement-description' => ['property' => 'landowner_agreement_description', 'label' => 'Explanation of landowner agreement', 'input_type' => 'long-text'],
                'pro-pit-land-tenure-risks' => ['property' => 'land_tenure_risks', 'label' => 'Risks or challenges in securing tenure arrangements with landowners', 'input_type' => 'long-text'],
                'pro-pit-non-tree-interventions-description' => ['property' => 'non_tree_interventions_description', 'label' => 'Additional non-tree intervention description', 'input_type' => 'long-text'],
                'pro-pit-complement-existing-restoration' => ['property' => 'complement_existing_restoration', 'label' => 'Project complements existing restoration', 'input_type' => 'long-text'],
                'pro-pit-restoration-strategy-distribution' => ['property' => 'restoration_strategy_distribution', 'label' => 'Distribution of restoration strategies', 'input_type' => 'strategy-area', 'multichoice' => false, 'option_list_key' => 'restoration-strategies'],
                'pro-pit-land-use-type-distribution' => ['property' => 'land_use_type_distribution', 'label' => 'Distribution of land use systems', 'input_type' => 'strategy-area', 'multichoice' => false, 'option_list_key' => 'land-use-systems'],
                'pro-pit-land-tenure-distribution' => ['property' => 'land_tenure_distribution', 'label' => 'Distribution of land tenure agreement', 'input_type' => 'strategy-area', 'multichoice' => false, 'option_list_key' => 'land-tenures'],
                'pro-pit-total-tree-second-yr' => ['property' => 'total_tree_second_yr', 'label' => 'Trees Planted in Second Year', 'input_type' => 'number'],
                'pro-pit-proj-survival-rate' => ['property' => 'proj_survival_rate', 'label' => 'Projected Project Survival Rate', 'input_type' => 'number-percentage'],
                'pro-pit-anr-approach' => ['property' => 'anr_approach', 'label' => 'Project Approach to ANR', 'input_type' => 'text'],
                'pro-pit-anr-rights' => ['property' => 'anr_rights', 'label' => 'How to Secure Rights to Conduct ANR', 'input_type' => 'text'],
                'pro-pit-project-site-model' => ['property' => 'project_site_model', 'label' => 'Project site distribution model', 'input_type' => 'select', 'multichoice' => false, 'option_list_key' => 'siting-strategies'],
                'pro-pit-indigenous-impact' => ['property' => 'indigenous_impact', 'label' => 'Project Impacts or Benefits for Indigenous People', 'input_type' => 'text'],
                'pro-pit-barriers-project-activity' => ['property' => 'barriers_project_activity', 'label' => 'Barriers to Project Activities', 'input_type' => 'select', 'multichoice' => true, 'option_list_key' => 'project-barriers'],
                ...
                'pro-pit-anr-practices-proposed' => ['property' => 'anr_practices_proposed', 'label' => 'ANR practices that the organization will use during the project', 'input_type' => 'select', 'multichoice' => true, 'option_list_key' => 'anr-practices'],
                ...
                'pro-pit-full-time-clt-jobs-count' => ['property' => 'full_time_clt_jobs_aggregate', 'label' => 'Aggregate full time CLT jobs', 'input_type' => 'number'],
                'pro-pit-part-time-jobs-count' => ['property' => 'part_time_jobs_aggregate', 'label' => 'Aggregate part time jobs', 'input_type' => 'number'],
                'pro-pit-part-time-clt-jobs-count' => ['property' => 'part_time_clt_jobs_aggregate', 'label' => 'Aggregate part time CLT jobs', 'input_type' => 'number'],
        ...
        'project' => [
            ...
            'fields' => [
                ...
                'pro-land-use-types' => ['property' => 'land_use_types', 'label' => 'Land use types', 'input_type' => 'select-image', 'multichoice' => true, 'option_list_key' => 'land-use-systems'],
                'pro-restoration_strategy' => ['property' => 'restoration_strategy', 'label' => 'Restoration strategy', 'input_type' => 'select-image', 'multichoice' => true, 'option_list_key' => 'restoration-strategies'],
                'pro-land-tenure-proj-area' => ['property' => 'land_tenure_project_area', 'label' => 'Land tenure', 'input_type' => 'select-image', 'multichoice' => true, 'option_list_key' => 'land-tenures'],
                'pro-country' => ['property' => 'country', 'label' => 'Country', 'input_type' => 'select', 'multichoice' => false, 'option_list_key' => 'gadm-level-0'],
                ...
                'pro-siting-strategy' => ['property' => 'siting_strategy', 'label' => 'Siting Strategy', 'input_type' => 'select', 'multichoice' => false, 'option_list_key' => 'siting-strategies'],
                ...
                'pro-states' => ['property' => 'states', 'label' => 'States', 'input_type' => 'select', 'multichoice' => true, 'option_list_key' => 'gadm-level-1'],
                ...
                'pro-full-clt-time-jobs-count' => ['property' => 'full_time_clt_jobs_aggregate', 'label' => 'Aggregate full time CLT jobs', 'input_type' => 'number'],
                'pro-part-time-jobs-count' => ['property' => 'part_time_jobs_aggregate', 'label' => 'Aggregate part time jobs', 'input_type' => 'number'],
                'pro-part-clt-time-jobs-count' => ['property' => 'part_time_clt_jobs_aggregate', 'label' => 'Aggregate part time CLT jobs', 'input_type' => 'number'],
                ...
                'pro-community-engagement-plan' => ['property' => 'community_engagement_plan', 'label' => 'Community engagement plan', 'input_type' => 'long-text'],
                'pro-direct-beneficiaries-goal-description' => ['property' => 'direct_beneficiaries_goal_description', 'label' => 'Direct beneficiaries goal description', 'input_type' => 'long-text'],
        ...
        'site' => [
            ...
            'fields' => [
                ...
                'site-land-use-types' => ['property' => 'land_use_types', 'label' => 'Land use types', 'input_type' => 'select-image', 'multichoice' => true, 'option_list_key' => 'land-use-systems'],
                'site-restoration-strategy' => ['property' => 'restoration_strategy', 'label' => 'Restoration strategy', 'input_type' => 'select-image', 'multichoice' => true, 'option_list_key' => 'restoration-strategies'],
                'site-anr-practices' => ['property' => 'anr_practices', 'label' => 'ANR practices', 'input_type' => 'select', 'multichoice' => true, 'option_list_key' => 'anr-practices'],
